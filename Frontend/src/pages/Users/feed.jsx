			...
			<>
				<div className="col-span-2 m-auto mb-5 h-full max-w-3xl space-y-6 overflow-hidden overflow-y-auto p-4 lg:pt-6">
					<Card>
						...
						<div className="space-y-4">
							<p className="text-base font-normal text-gray-500 dark:text-gray-400">
								Hi @everyone, the new designs are attached. Go check them out
								and let me know if I missed anything. Thanks!
							</p>
					...
					<Card>
						...
						<div className="space-y-4">
							<p className="text-base font-normal text-gray-500 dark:text-gray-400">
								I've been working on my app and grew it to $22k MMR in just a
